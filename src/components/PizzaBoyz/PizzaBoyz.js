				...
				<div className="jumbotron-container">
					...
					<div className="jumbo-info-container">
						<p>
							...
							<br></br>Mon - Thur 11:00 AM - 8:30 PM
				...
				<div className="menu-container" id="theMenu">
					...
					<div className="specials-container menu-section">
						<div className="menu-title">
							SPECIALS
							<div className="menu-note">
								- Add a side salad to any daily special for $3.99 -
							</div>
						</div>
					...
					<div className="dessert-container menu-section">
						<div className="menu-title">DESSERT</div>

						<div className={lineStyle}></div>
						<div className="menu-items-container pizza-menu">
							{data.menu.dessert.map((item) => (
								<div
									className="menu-item"
									data-aos="fade-down"
									data-aos-once="true"
